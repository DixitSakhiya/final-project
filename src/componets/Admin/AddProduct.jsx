...
export default function AddProduct() {
    ...
    const productdecription = useRef("");
    ...
    const AddProductHandler =(e)=> {
        ...
        var insert={
          ...
          productdecription:productdecription.current.value
        }
                ...
                <div className="main-content-inner">
                  ...
                  <div className="main-content-wrap">
                    ...
                    <div className="wg-box">
                      <form onSubmit={AddProductHandler} className="form-new-product form-style-1" >
                        <fieldset className="name">
                          <div className="body-title">
                        ...
                        <fieldset className="name">
                          <div className="body-title">
                            Product Image <span className="tf-color-1">*</span>
                          </div>
                          <input
                            className="flex-grow"
                            type="text"
                        ...
                        <fieldset className="name">
                          <div className="body-title">
                            Product Decription <span className="tf-color-1">*</span>
                          </div>
                          <input
                            className="flex-grow"
                            type="text"
                            ref={productdecription}
                            placeholder="Product Decription"
                          />
                        </fieldset>
                        <fieldset className="category">
                          <div className="body-title">Product Price</div>
                          <div className=" flex-grow">
                          <input
                            className="flex-grow"
                            type="number"
                        ...
                        <div className="bot">
                          <div />
                          <input className="tf-button w208" type="submit"  value="submit"/>
                        </div>
                      </form>
                    </div>
                    {/* /new-category */}
