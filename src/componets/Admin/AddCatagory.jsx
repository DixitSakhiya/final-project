...
export default function AddCatagory() {
  ...
  const AddCatagoryHandler =(e)=>{
    e.preventDefault();
      var insert = {
        catagoryname:catagorynameRef.current.value,
        added_date:added_dateRef.current.value
      }
      axios.post(`http://localhost:8000/addcategory`,insert).then(()=>{
        Swal.fire({
          title: "Wow", // Corrected title
          text: "Thanks for adding your category",
          icon: "success"
    });
  });
  e.target.reset();
                ...
                <div className="main-content-inner">
                  ...
                  <div className="main-content-wrap">
                    ...
                    <div className="wg-box">
                      <h1>Add Category</h1>
                      <form onSubmit={AddCatagoryHandler} className="form-new-product form-style-1" >
                        <fieldset className="name">
                          <div className="body-title">
                        ...
                        <fieldset className="category">
                          <div className="body-title">Select Date</div>
                          <div className=" flex-grow">
                          <input
                            className="flex-grow"
                            type="date"
